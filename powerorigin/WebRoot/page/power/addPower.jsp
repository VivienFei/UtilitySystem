	...
	<body><div id="body-wrapper">
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-header">
					...
					<h3>Add Electricity Price Information</h3>
		 ...
		 <script type="text/javascript">
			...
			var isExist=false;
					...
					if($("#loginname").val()=="")
						{
							$("#showloginInfo").html("Loginname cannot be empty");
							$("#loginname").focus();
							return;
						}
					...
					if(data=="false"){
							...
							isExist=true;
							$("#showloginInfo").html("User exists");
						}
						
					});
					
					$.post("<%=path %>/getPowerBeforeCount.do",
					{
						loginname:$("#loginname").val()
					...
					$("#submitid").click(function(){
						...
						{
						$("#showerr").show();
							$("#erreinfo").html("User does not exists");
							return false;
						}
					if(!regex.exec($("#loginname").val())){
						...
						$("#showerr").show();
						$("#erreinfo").html("Should be not negative！");
						$("#nowid").focus();
						    return false;
					...
					if(data=="true"){
							$("p").hide();
							$("#showerr").show();
							$("#erreinfo").html("Add Successfully<a href='<%=path %>/page/power/addPower.jsp'> Back</a>");
						}else{
							$("#showerr").show();
							$("#erreinfo").html("Already add the loginname<a href='<%=path %>/page/power/addPower.jsp'> Back</a>");
						}
