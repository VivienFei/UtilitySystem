		 ...
		 <script type="text/javascript">
			...
			var isExist=false;
					...
					if(data=="true"){
							...
							$("#showloginInfo").html("User alrady exits, cannot sign up");
							isExist=true;
					
						}else{
							isExist=false;
							$("#showloginInfo").html("can sign up");
						}
					...
					$("#submitid").click(function(){
						...
						{
						$("#showerr").show();
							$("#erreinfo").html("Sorry user exists");
							return false;
						}
					if(!regex.exec($("#loginname").val())){
					...
					if(data=="true"){
							$("p").hide();
							$("#showerr").show();
							$("#erreinfo").html("Add Successfully！<a href='<%=path %>/page/user/addUser.jsp'> Back</a>");
						}else{
							$("#showerr").show();
							$("#erreinfo").html("User Already Exists");
						}
