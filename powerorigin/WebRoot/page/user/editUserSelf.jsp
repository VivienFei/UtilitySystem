			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-content">
					...
					<form action="#" method="post">
						...
						<div id="inputjobfair">
						<input value="${user.id}" value="" type="hidden" id="id" />
								<p>
									<label>Loginname:
										<input disabled="disabled" class="text-input medium-input" value="${user.loginname}" type="text" id="loginname" name="loginno" /> <span id="showloginInfo" style="color:red;"> </span></label>
								</p>
								<p>
									<label>pass&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;word:
										<input class="text-input medium-input" value="${user.password}"  type="password" id="password"  /> <span id="showpasswordInfo" style="color:red;"> </span></label>
								</p>
								<p>
									<label>Username:
										<input class="text-input medium-input" value="${user.username}"   type="text" id="username"  /> </label>
								</p>
						
								<p>
									<label>Addre&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ss:
										<input class="text-input medium-input" value="${user.address}"  type="text" id="address"   /> </label>
								</p>
						
								<p>
									<label>Tele&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;phone:
										<input class="text-input medium-input" value="${user.phone}"  id="phone" /> </label>
								</p>
		 ...
		 <script type="text/javascript">
			$(document).ready(function(){
					...
					if($("#password").val()=="")
						{
							...
							$("#showpasswordInfo").html("Wrong format！");
							return false;
							...
							if($("#password").val()=="")
						{
							...
							if(!regex.exec($("#password").val())){
							$("#showpasswordInfo").html("Wrong forma！");
							return false;
					...
					if(data=="true"){
							$("p").hide();
							$("#showerr").show();
							$("#erreinfo").html("Edit Successfully！<a href='<%=path %>/page/admin/main.jsp'> Back to front page</a>");
						}else{
							$("#showerr").show();
							$("#erreinfo").html("fail to edit<a href='<%=path %>/page/admin/main.jsp'> Back to front page</a>");
						}
